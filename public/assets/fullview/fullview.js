        ...
        utilites: function() {
            ...
            this.createDots = function createDots() {
                ...
                if (!$created) {
                    ...
                    var div = $("<div>").attr("id", "fv-dots").addClass("navbar-default border border-danger").append('<ul>');

                    $.each(IDs, function(key, value) {
                        //console.log("IDs =" + key + ": " + value); /*<span></span>*/
                        div.find('ul').append('<li class="nav-item p-0  border border-success "><a data-scroll="' + key + '" href="' + $("#" + value).attr('href') + '" id="fv-' + value + '" class="nav-link px-1">' + $("#" + value).text() + '</a></li>').addClass('px-0 mb-0')

                    });

                    /*this.$views.each(function(i) {
                        div.find('ul').append('<li><a data-scroll="' + i + '" href="#" class=""><span>NAME-' + i + '</span></a></li>')
                    });*/
            ...
            this.changeActiveStatus = function changeActiveStatus($view) {
                ...
                //$("#fv-dots").find(".active").each(function() {  });


                if (this.options.dots) {
                    $.each(this.$dotsElement, function(key, element) {
                        //console.log('key: ' + key + '\n' + 'value: ' + element + " $view: " + $view);
                        ...
                        if (key === $view) {
                            ...
                            $.each(IDs, function(key, value) {
                                //console.log("IDs =" + key + ": " + value); /*<span></span>*/
                                if (value.toString().toLowerCase().includes(eleId[1].toLowerCase())) {
